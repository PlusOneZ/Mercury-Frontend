    ...
    <el-container>
        ...
        <el-main class="bg-white">
            <ol class="chat">
                ...
                <div class="day">2021/07/11</div>
                <li class="self">
                    <div class="avatar"><img src="http://i.imgur.com/HYcn9xO.png" draggable="false"/></div>
                    <div class="msg">
                        <p>我想买这本书</p>
                        <img src="https://th.bing.com/th/id/R.a5ba9fe54864d03a2ae5538bdccaece3?rik=N8zPqAhnrleFNw&riu=http%3a%2f%2fimgx.xiawu.com%2fxzimg%2fi4%2fi4%2fT1XppsFqxeXXXXXXXX_!!0-item_pic.jpg&ehk=P0j81PHKHHe2lMmM914hjAZCqdOusdm6DDcv2YWQBpo%3d&risl=&pid=ImgRaw"/>
                        <time>18:03</time>
                    </div>
                </li>
                <li class="other">
            ...
            <el-button type="primary" round class="flex justify-end " >发送</el-button>
        </el-main>
    </el-container>
</template>
...
.emojis:hover:not(.emojis:active) {
    opacity: 0.5;
}
</style>
